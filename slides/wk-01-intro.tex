...
\begin{itemize}
\item \txx{LAC Language and the Computer} --- solving NLP problems with Python: introduces both programming and linguistics
\item \txx{??? Corpus Linguistics} --- empirical research on language use
\end{itemize}

\myslide{Guidelines for Written Work}

\begin{itemize}
\item All assignments must follow the local guidelines
  \begin{itemize}
%  \item You can get it from: \url{http://linguistics.hss.ntu.edu.sg/CurrentStudents/Pages/Resources.aspx}
  \item Be careful with  citation, transcription, formatting
...
\\ \href{https://fcbond.github.io/static/img/ling-style.pdf}{\textit{(Computational) Linguistic Style Guidelines: a guide for the flummoxed}}
\end{itemize}
