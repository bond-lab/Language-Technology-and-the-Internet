...
\begin{center}
  \includegraphics[width=\textwidth]{../pics/Internet_users_per_100_inhabitants_ITU}
\end{center}
...
\item Huge amount of information
  \begin{itemize}
  \item Looking for \grn{Eric Miller} may get the wrong one!
  \item Looking for \grn{NTU} gets
    \begin{itemize}
...
\MyLogo{\url{Wikipedia:World Wide Web}}
